              ...
              <div>
                ...
                {formData.image && (
                    <div className="mt-4">
                        ...
                        <div className="relative group w-32 h-32 bg-gray-100 rounded-md p-1 shadow-inner flex items-center justify-center">
                            <img src={formData.image} alt="Xem trước danh mục" className="max-h-full max-w-full object-contain"/>
                            <button
                                type="button"
