        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            <div>
              ...
              {formData.image && (
                <div className="mt-4 flex h-48 w-full items-center justify-center rounded-md bg-gray-100 p-2">
                  <img src={formData.image} alt="Xem trước" className="max-h-full max-w-full rounded-md object-contain" />
                </div>
              )}
            </div>
            <div>
